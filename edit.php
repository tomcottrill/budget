...
<html lang="en">
	...
	<body>
				...
				<div id="wrapper" class="row-fluid main">
					<div class="span4 edit-sidebar">
						<ul id="edit-sidebar-tabs" class="nav nav-tabs">
							<li class="active">
								<a href="#sidebar-company-enter" data-toggle="tab" data-type="sidebar-company-enter">Enter hauler</a>
							</li>
							<li>
								<a href="#sidebar-company-choose" data-toggle="tab" data-type="sidebar-company-choose">Select hauler</a>
							</li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active" id="sidebar-company-enter">
								...
								<div class="input-append">
									...
									<button class="btn" type="button" id="load-company-subm">
										<i class="icon-play"></i>
									</button>
								</div>
					...
					<div class="span8 edit-main">
						<ul id="edit-tabs" class="nav nav-tabs">
							<li class="active">
								<a href="#company-summary" data-toggle="tab" data-type="company-summary">Summary</a>
							</li>
							<li>
								<a href="#company-areas" data-toggle="tab" data-type="company-areas" id="main-tab-areas">Areas</a>
							</li>
							<li>
								<a href="#company-addarea" data-toggle="tab" data-type="company-edit">Add more areas</a>
							</li>
							<li>
								<a href="#company-addalert" data-toggle="tab" data-type="">Alerts</a>
							</li>
							<li>
								<a href="#company-addpricingstructure" data-toggle="tab" data-type="">Pricing</a>
							</li>
							<li>
								<a href="#company-manageinfo" data-toggle="tab" data-type="">Add'l Information</a>
							</li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active" id="company-summary">
								<div id="company-summary-details" data-companyid="" data-companyname="" data-companylat="" data-companylng="" class="span12" style="display:none;margin-left:0px;">
									<div class="form-horizontal">
										<div class="control-group row-fluid form-inline">
											<label for="edit-company-name" class="control-label">
												<p class="text-info">
													Hauler name&nbsp;
												</p></label>
											<div class="controls">
									...
									<div class="form-horizontal">
										<div class="control-group row-fluid form-inline">
											<label for="edit-company-address" class="control-label">
												<p class="text-info">
													HQ address&nbsp;
												</p></label>
											<div class="controls">
									...
									<div class="form-horizontal">
										<div class="control-group row-fluid form-inline">
											<label for="edit-company-telephone" class="control-label">
												<p class="text-info">
													Telephone&nbsp;
												</p></label>
											<div class="controls">
									...
									<div class="form-horizontal">
										<div class="control-group row-fluid form-inline">
											<label for="edit-company-email" class="control-label">
												<p class="text-info">
													Email&nbsp;
												</p></label>
											<div class="controls">
									...
									<div class="form-horizontal">
										<div class="control-group row-fluid form-inline">
											<label for="edit-company-website" class="control-label">
												<p class="text-info">
													Website&nbsp;
												</p></label>
											<div class="controls">
									...
									<div class="form-horizontal">
										<div class="control-group row-fluid form-inline">
											<label for="edit-company-rank" class="control-label">
												<p class="text-info">
													Hauler usage rank&nbsp;
												</p></label>
											<div class="controls">
									...
									<div class="form-horizontal">
										<div class="control-group row-fluid form-inline">
											<div class="controls">
												<button id="edit-company-submit" class="btn btn-info">
													<i class="icon-ok icon-white"></i>&nbsp;Save changes
												</button>
												<button id="edit-company-delete" class="btn btn-danger">
													<i class="icon-trash icon-white"></i>&nbsp;Delete company
												</button>
											</div>
										</div>
									</div>
								...
								<div id="company-summary-welcome" class="span12" style="margin-left:0px;padding:10px;">
									...
									<p>
										Before using the edit interface, please take your time to learn how it works, and how it would be the easiest for you to use it!
									</p>
									<p>
										To the top left corner you will find the hauler lookup interface, which has two modes:
									</p>
									<ul>
										<li>
									...
									<p>
										Once you selected your desired hauler, follow the next step based on the nature of action you want to do with the hauler:
									</p>
									<ul>
										<li>
											If you want to manage the areas of the hauler, click on the areas tab! There you can easily delete or add hauler areas, while a visual representation of the areas will be shown on a google map
										</li>
										<li>
											If you want to change hauler details, click on the summary tab! Once you are done with your changes, simply click on the Save Changes button.You can also delete the hauler and its areas completely by clicking on the Delete button.
										</li>
										<li>
											If you want to add more hauler areas right away, click on the Add more areas tab! There you can select what type of hauler area you want to add.
										</li>
									</ul>
									<p>
										IMPORTANT: On the Summary page, when you change to HQ address of a hauler, please make sure that you enter a valid address, otherwise the app will return an error, that it was unable to geocode your request!
									</p>
								</div>
							</div>
							<div class="tab-pane" id="company-areas">
								...
								<div id="edit-company-areas" class="span12" style="overflow-y:auto;overflow-x:none;margin-left:0px;">
									<table class="table table-condensed table-bordered table-hover">
										<thead>
											<tr class=" table-thickheadered">
												<td class="text-center">Provider ID</td><td class="text-center">Area type</td><td class="text-center">Area description</td><td class="text-center">Available operations</td>
											</tr>
										</thead>
										<tbody id="company-areas-list">
											<tr>
												<td colspan="4" style="text-align:center;">No hauler areas are loaded. Please select a hauler first!</td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="tab-pane" id="company-addarea">
								<div id="edit-company-addarea" class="span12" style="overflow:hidden;margin-left:0px;">
									<ul id="edit-company-addarea-pill-types" class="nav nav-pills">
										<li class="active">
											<a data-toggle="tab" data-type="addarea-zip" href="#edit-company-addarea-pill-zip">ZIP code area</a>
										</li>
										<li>
											<a data-toggle="tab" data-type="addarea-county" href="#edit-company-addarea-pill-county">County area</a>
										</li>
										<li>
											<a data-toggle="tab" data-type="addarea-radial" href="#edit-company-addarea-pill-radius">Radial area</a>
										</li>
										<li>
											<a data-toggle="tab" data-type="addarea-custom" href="#edit-company-addarea-pill-custom">Custom area</a>
										</li>
									</ul>
									<div class="pill-content">
										<div class="active pill-pane" id="edit-company-addarea-pill-zip">
											<div id="edit-company-addarea-zipcode-controls" class="form-horizontal">
												<div class="control-group row-fluid form-inline">
													<div class="controls">
														...
														<button id="edit-company-addarea-zipcode-submit" class="btn btn-info">
											...
											<div class="span12" id="edit-company-addarea-zipcode-list" style="overflow-y:auto;overflow-x:hidden;margin:0px;">
												<table class="table table-bordered table-condensed table-hover" style="height:auto">
													<thead>
														<tr class=" table-thickheadered">
															<td class="text-center">ZIP code</td><td class="text-center">Operation</td>
														</tr>
													</thead>
											...
											<div class="row">
												<div class="span12" style="text-align:center;margin-top:20px;">
													<button id="edit-company-addarea-zipcode-save" class="btn btn-info">
														<i class="icon-ok icon-white"></i>&nbsp;Save ZIP codea areas to database
													</button>
												</div>
											</div>
										...
										<div class="pill-pane" id="edit-company-addarea-pill-county">
											<div id="edit-company-addarea-county-controls" class="form-horizontal">
												<div class="control-group row-fluid form-inline">
													<div class="controls">
														...
														<button id="edit-company-addarea-county-submit" class="btn btn-info">
															Add county to list
														</button>
													</div>
												</div>
											...
											<div class="span12" id="edit-company-addarea-county-list" style="overflow-y:auto;overflow-x:hidden;margin:0px;">
												<table class="table table-bordered table-condensed table-hover" style="height:auto">
													<thead>
														<tr class=" table-thickheadered">
															<td class="text-center">County name</td><td class="text-center">Operation</td>
														</tr>
													</thead>
													<tbody id="edit-company-addarea-county-list-table"></tbody>
												</table>
											</div>

											<div class="row">
												<div class="span12" style="text-align:center;margin-top:20px;">
													<button id="edit-company-addarea-county-save" class="btn btn-info">
														<i class="icon-ok icon-white"></i>&nbsp;Save county areas to database
													</button>
												</div>
											</div>
										</div>
										...
										<div class="pill-pane" id="edit-company-addarea-pill-radius">
											...
											<div class="row" style="margin-top:20px;text-align:center;">
												<div class="btn-group">
													<button class="btn" id="radi_1">
														1
													</button>
													<button class="btn" id="radi_2">
														2
													</button>
													<button class="btn" id="radi_3">
														3
													</button>
													<button class="btn" id="radi_4">
														4
													</button>
												</div>
											</div>
											...
											<div class="row" style="margin-top:20px;">
												<div class="span12" style="text-align:center;">
													<button id="edit-company-addarea-radius-save" class="btn btn-info">
														<i class="icon-ok icon-white"></i>&nbsp;Save radius area(s) to database
													</button>
													<button id="edit-company-addarea-radius-display" class="btn btn-info">
														<i class="icon-play icon-white"></i>&nbsp;Test
													</button>
													<button id="edit-company-addarea-radius-cancel" class="btn btn-danger">
														<i class="icon-trash icon-white"></i>&nbsp;Clear
													</button>
												</div>
											</div>
										</div>
										...
										<div class="pill-pane" id="edit-company-addarea-pill-custom">
											...
											<div class="row">
												<div class="span12 form-inline" style="text-align:center;">
													...
													<button id="edit-company-addarea-custom-locate" class="btn btn-info">
														<i class="icon-map-marker icon-white"></i>&nbsp;Zoom to location
													</button>
												</div>
											</div>
											...
											<div class="row" style="margin-top:20px;">
												<div class="span12" style="text-align:center;">
													<button id="edit-company-addarea-custom-save" class="btn btn-info">
														<i class="icon-ok icon-white"></i>&nbsp;Save custom area to database
													</button>
													<button id="edit-company-addarea-custom-cancel" class="btn btn-danger">
														<i class="icon-trash icon-white"></i>&nbsp;Clear
													</button>
												</div>
											</div>
							...
							<div class="tab-pane" id="company-addalert">
								...
								<form>
									<fieldset>
										...
										<span class="help-block">This alert will pop up whenever anyone clicks on the search results.</span>

									</fieldset>

								</form>
								<button id="edit-company-addalert" class="btn btn-info">
									<i class="icon-trash icon-white"></i>&nbsp;Add
								</button>
								<button id="edit-company-delalert" class="btn btn-danger">
									<i class="icon-trash icon-white"></i>&nbsp;Delete Alert
								</button>

							</div>

							<div class="tab-pane" id="company-addpricingstructure">
								<table class="table table-striped table-bordered pstable">
								...
								<form>
									<select name = "wastetype">
										<?php
										$_GET["type"] = "html";
										include ("php/includes/wastetypelist.php");
										?>
									</select>
									<br>

								</form>
								<button id="edit-company-addps" class="btn btn-info">
									<i class="icon-trash icon-white"></i>&nbsp;Add
								</button>

							</div>
							<div class="tab-pane" id="company-manageinfo">
								<div class="well eitable">
		...
		<script src="js/src/editable-form/editable-form.js"></script>
		<script src="js/bootstrap-editable/js/bootstrap-editable.min.js"></script>
		<link href="js/bootstrap-editable/js/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/bootstrap-wysihtml5-0.0.2.css" rel="stylesheet" type="text/css">
		</link>
		<script src="js/bootstrap-editable/js/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/wysihtml5-0.3.0.min.js"></script>
		<script src="js/bootstrap-editable/js/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/bootstrap-wysihtml5-0.0.2.min.js"></script>
		<script src="js/bootstrap-editable/js/inputs-ext/wysihtml5/wysihtml5.js"></script>
		<script>
...
companyDetails($("#cid").val(), $("#load-company-subm > i"), {
a : "icon-time",
b : "icon-play"
});
});
...
$.post("actions/manageps.php", {
action : "delete",
id : $(this).attr("rel")
}, function(data, status) {
alert(data);
$.get('php/includes/listpricingstructures.php?id=' + providerID, function(data) {
$('.pstable').html(data);
$('.test').editable({
...
$("textarea[name=alert]").append(data.body[0].Alert);
$.get('php/includes/listpricingstructures.php?id=' + id, function(data) {
$('.pstable').html(data);
$(".pstable").on("click", ".delps", delps);
$('.test').editable({
success : function(response, newValue) {
if (response.status == 'error')
return response.msg;
...
source: [{value: 'Flat Rate', text: 'Flat Rate'},
{value: 'Haul Plus', text: 'Haul Plus'}]
});
...
source: [{value: 'AST', text: 'Puerto Rico'},
{value: 'EDT', text: 'EST'}, {value: 'CST', text: 'CST'}, {value: 'MDT', text: 'MDT'}, {value: 'PDT', text: 'PST'}, {value: 'Alaska', text: 'PDT'}, {value: 'HST', text: 'Hawaii'}]
});

$(".pstable").on("click", ".delps", delps);
});

$.get('php/includes/extendedinfo.php?id=' + id, function(data) {
$('.eitable').html(data);
//$(".pstable").on("click", ".delps", delps);
//$('.test').editable({
//	success : function(response, newValue) {
...
var currentFeature_or_Features = new GeoJSON($.parseJSON(record.geom), {
strokeColor : "#FFFF00",
strokeWeight : 2,
strokeOpacity : 0.75
});
...
$.post("php/manage.php", {
mode : "deletesingle",
pid : $(this).attr("data-cid"),
aid : $(this).attr("data-cdbid")
}, function(data) {
//Area deleted
companyDetails($("#company-summary-details").attr("data-companyid"), $("#load-company-subm > i"), {
a : "icon-time",
b : "icon-play"
});
});
...
companyDetails($(this).attr("data-pid"), record, {
a : "icon-time",
b : "icon-arrow-right"
});
});
...
radii.push({
radius : $(this).find("[data-dtype='radius']").val(),
note : $(this).find("[data-dtype='note']").val()
});
}
});

var obj = {
"lat" : $("#company-summary-details").attr("data-companylat"),
...
providerManager.geocoder.geocode({
"address" : address
...
if (data.status = "success") {
companyDetails(data.provider_id, $("#load-company-subm > i"), {
a : "icon-time",
b : "icon-play"
});
...
//HERE
$("#edit-company-addalert").click(function() {
providerID = $("#company-summary-details").attr("data-companyid");
alertText = $("textarea[name=alert]").val();
...
$("#edit-company-addps").click(function() {
providerID = $("#company-summary-details").attr("data-companyid");

$.post("actions/manageps.php", {
action : "add",
id : providerID,
wastetype : $("select[name=wastetype]").val()
...
?>
	...
	$("#edit-company-delalert").click(function() {
		providerID = $("#company-summary-details").attr("data-companyid");
		...
		$.post("updatealert.php", {
			...
			alert(data);
			$("textarea[name=alert]").html('');
			$("textarea[name=alert]").val('');
		});
	...
	$("#edit-company-addarea-radius-display").click(function() {
		...
		for ( i = 0; i < radii.length; i++) {
			providerManager.radiusAreas.push(new google.maps.Polygon({
				paths : [drawCircle(new google.maps.LatLng(centerLat, centerLng), parseInt(radii[i]), 1), drawCircle(new google.maps.LatLng(centerLat, centerLng), parseInt(radii[i + 1]), -1)],
				strokeColor : "#0000FF",
				strokeOpacity : 0.8,
				strokeWeight : 2,
				fillColor : "#FF0000",
				fillOpacity : 0.35,
				map : providerManager['radiusmap']
			}));
		}
