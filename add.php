				...
				<div id="wrapper" class="row-fluid main">
					<div id="sidebar" class="span8 sidebar">
						<ul id="tabs" class="nav nav-tabs">
							<li class="active">
								<a href="#tabs1-pane1" data-toggle="tab" data-type="detail">Add provider details</a>
							</li>
							<li>
								<a href="#tabs1-pane2" data-toggle="tab" data-type="zip">Add ZIP code area(s)</a>
							</li>
							<li>
								<a href="#tabs1-pane3" data-toggle="tab" data-type="county">Add county area(s)</a>
							</li>
							<li>
								<a href="#tabs1-pane4" data-toggle="tab" data-type="radius">Add radius area(s)</a>
							</li>
							<li>
								<a href="#tabs1-pane5" data-toggle="tab" data-type="custom">Add custom area(s)</a>
							</li>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tabs1-pane1">
								<fieldset>
									...
									<div class="span5">
										...
										<button id="btnpinit" class="btn btn-success btnpinit">
											Pin and save
										</button>
										...
										<button id="pd_save" class="btn btn-success">
											Save details
										</button>
									</div>
									<div id="main-map" class="span6 main-map"></div>
								</fieldset>
							</div>
							<div class="tab-pane" id="tabs1-pane2">
								<fieldset>
									...
									<form class="form-inline">
										...
										<button id="add_zipcode" class="btn">
											Add to list
										</button>
										<button id="save_zipcode" class="btn btn-success">
											Save ZIP codes
										</button>
									</form>
							...
							<div class="tab-pane" id="tabs1-pane3">
								<fieldset>
									...
									<form class="form-inline">
										...
										<button id="add_county" class="btn">
											Add to list
										</button>
										<button id="save_county" class="btn btn-success">
											Save counties
										</button>
									</form>
							...
							<div class="tab-pane" id="tabs1-pane4">
								<fieldset>
									...
									<ul id="ranges" class="radial_ranges"></ul>

									<button class="btn btn-success saveranges" id="ranges_cancel">
										Cancel
									</button>
									<button class="btn btn-success saveranges" id="saveranges">
										Save
									</button>
									<button class="btn btn-success saveranges" id="displayranges">
										Display
									</button>
							...
							<div class="tab-pane" id="tabs1-pane5">
								<fieldset>
									...
									<button class="btn btn-danger" id="custom_clear" style="float:right;margin:5px;">
										Clear
									</button>
									<button class="btn btn-success" id="custom_save" style="float:right;margin:5px;">
										Save
									</button>
					...
					<div id="main" class="span4 main-content" style="padding:10px;">
						<!--Body content-->
						<button class="btn btn-danger" id="start_new" style="float:left;">
							Start new
						</button>
						<button class="btn btn-success" id="save_information" style="float:right;">
							Save All
						</button>
